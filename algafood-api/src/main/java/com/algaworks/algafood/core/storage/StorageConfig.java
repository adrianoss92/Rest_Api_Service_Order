...
public class StorageConfig {
	...
	/*
	 * Método utilizado para passar as credenciais do usuário na hora de salvar um arquivo no s3
	 * */
	@Bean
	...
	/*
	 * Método utilizado para definir qual o tipo de ambiente será utilizado para armazenar as fotos no s3
	 * */
	@Bean
